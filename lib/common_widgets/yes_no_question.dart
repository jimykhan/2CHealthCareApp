...
class YesNoQuestion extends StatelessWidget {
  ...
  YesNoQuestion({required this.isChecked,this.challengeName,required this.pressYes,
    required this.pressNo,this.textEditingController,this.question,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            child: Text(question??"My Religion/Spirituality impacts my health care:",
          ...
          ApplicationSizing.verticalSpacer(),
          disableComment ? Container() : Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Container(
...
class fourOptionQuestion extends StatelessWidget {
  ...
  String? option4;
  TextEditingController? textEditingController;
  fourOptionQuestion({this.challengeName,this.textEditingController,this.question,
    this.disableComment = false,
    this.option1,this.option2,this.option3,this.option4,
    required this.onOption1,required this.onOption2,required this.onOption3,required this.onOption4,
              ...
              children: [
               Row(
                    ...
                    children: [
                      Expanded(
                        flex: 1,
                        child: RadioButton(buttonSelected: selectedOption == 1 ? true : false, onchange: onOption1,
                          disableText: false,
                          text: option1??"",
                        ),
                      ),
                      Expanded(
                        flex: 1,
                        child: RadioButton(buttonSelected: selectedOption == 2 ? true : false, onchange: onOption2,
                          disableText: false,
                          text: option2??"",
                        ),
                      ),
               ...
               Row(
                    ...
                    children: [
                      Expanded(
                        flex: 1,
                        child: RadioButton(buttonSelected: selectedOption == 3 ? true : false, onchange: onOption3,
                          disableText: false,
                          text: option3??"",
                        ),
                      ),
                      Expanded(
                        flex: 1,
                        child: RadioButton(buttonSelected: selectedOption == 4 ? true : false, onchange: onOption4,
                          disableText: false,
                          text: option4??"",
                        ),
                      ),
