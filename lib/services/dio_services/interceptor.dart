...
class ApiInterceptor extends Interceptor {
    ...
    switch (err.type) {
      ...
      case DioErrorType.badResponse:
        switch (err.response?.statusCode) {
          case 400:
            throw BadRequestException(err.requestOptions, data: err);
          case 401:
            throw UnauthorizedException(err.requestOptions,
                data: err.response?.statusMessage);
          case 404:
  ...
  void onRequest(
    ...
    if(loginVM.currentUser == null) await loginVM.getCurrentUserFromSharedPref();
    ...
    if (loginVM.currentUser?.bearerToken != null) {
      ...
      if (hasExpired) {
        ...
        if (res == null) {
          SnackBarMessage(
              message: "Sorry, your token expired, please login again");
          loginVM.userLogout();
          return;
        } else if (res is bool) {
          return;
