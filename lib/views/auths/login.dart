...
class Login extends HookWidget {
  ...
  String? path;
  Login({Key? key,this.path}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    ApplicationStartupService applicationStartupService =
        useProvider(applicationStartupServiceProvider);
        ...
        children: [
            ...
            children: [
              false
                  ...
                  : InkWell(
                      onTap: () async {
                        if (loginVM
                            .fieldValidation(loginVM.emailController.text)) {
          ...
          false
              ...
              : CustomFilledButton(
                  ...
                  txt: "Login",
                  color1:
                      !(loginVM.isPrivacyPolicyChecked) ? appColorLight : null,
                  onTap: !(loginVM.isPrivacyPolicyChecked)
                      ? null
                      : () async {
                          // dd();
                          ...
                          if (checkMail && checkPassword) {
                            ...
                            if (isValid) {
                              applicationStartupService.applicationStart(
                                  fromLogin: true);
