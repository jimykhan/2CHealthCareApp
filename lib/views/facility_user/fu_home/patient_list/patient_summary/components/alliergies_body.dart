...
Widget build(BuildContext context) {
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        HeadLineTextStyle(text: "Allergies",),
        allergeTile(),
        SizedBox(height: 10,),
        allergeTile(),
        SizedBox(height: 10,),
  ...
  return CommonContainer(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Text("Allergies ",style: Styles.PoppinsRegular(
                  ...
                  Container(
                    ...
                    child: Wrap(
                      ...
                      children: ["Allergy","Allergy","Allergy"].map((e) => createRandomBox(e)).toList(),),
                  ),
                ],
              ),
            )
        ...
        Expanded(
            ...
            child: Container(
              // color: Colors.pink,
                child: Column(
                  children: [
                    Text("Dec 20 2020",style: Styles.PoppinsRegular(
                        fontWeight: FontWeight.w500,
                    ...
                    Container(
                      ...
                      child: Text("Active",style: Styles.PoppinsRegular(
                          fontWeight: FontWeight.w500,
    ...
    Widget createRandomBox(String text){
        ...
        return Container(
          ...
          child: Text(text,style: Styles.PoppinsRegular(
            fontSize: ApplicationSizing.constSize(10),
            color: ramdomColor,
            fontWeight: FontWeight.w500
          ),),
